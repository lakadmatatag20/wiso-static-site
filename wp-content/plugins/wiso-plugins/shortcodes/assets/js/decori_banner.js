...
var bgColor = jQuery('.decori-banner').data('bg-color');
var animColor = jQuery('.decori-banner').data('animation-color');
var animColor2 = jQuery('.decori-banner').data('animation-color-2');
var canvas = document.querySelector('canvas');
var width = canvas.offsetWidth,
  height = canvas.offsetHeight;

var colors = [
  new THREE.Color(animColor2),
  new THREE.Color(animColor),
...
loader.crossOrigin = "";
var dotTexture = loader.load("../wp-content/plugins/wiso-plugins/shortcodes/assets/images/dotTexture.png");
var dotsAmount = 3000;
